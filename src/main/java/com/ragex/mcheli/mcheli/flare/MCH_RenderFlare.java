  ...
  extends W_Render
{
  ...
  public void doRender(Entity entity, double posX, double posY, double posZ, float yaw, float partialTickTime)
  {
    ...
    GL11.glEnable(2884);
    double x = entity.prevPosX + entity.motionX * partialTickTime;
    double y = entity.prevPosY + entity.motionY * partialTickTime;
    double z = entity.prevPosZ + entity.motionZ * partialTickTime;
