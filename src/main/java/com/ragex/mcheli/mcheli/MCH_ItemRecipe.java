...
public class MCH_ItemRecipe implements MCH_IRecipeList
{
  ...
  public static MCH_ItemRecipe getInstance() { return instance; }
  ...
  private static void registerCommonItemRecipe()
  {
    ...
    for (int i = 0; i < MCH_MOD.itemUavStation.length; i++)
      addRecipeList(addRecipe(MCH_MOD.itemUavStation[i], MCH_Config.ItemRecipe_UavStation[i].prmString));
    ...
    addRecipeList(addRecipe(MCH_MOD.itemStingerBullet, "2," + MCH_Config.ItemRecipe_StingerMissile.prmString));
    addRecipeList(addRecipe(MCH_MOD.itemJavelin, MCH_Config.ItemRecipe_Javelin.prmString));
    addRecipeList(addRecipe(MCH_MOD.itemJavelinBullet, "2," + MCH_Config.ItemRecipe_JavelinMissile.prmString));
    addRecipeList(addRecipe(MCH_MOD.itemSpawnGunnerVsMonster, MCH_Config.ItemRecipe_GunnerVsMonster.prmString));
    addRecipeList(addRecipe(MCH_MOD.itemSpawnGunnerVsPlayer, MCH_Config.ItemRecipe_GunnerVsPlayer.prmString));
    addRecipeList(addRecipe(W_Item.getItemFromBlock(MCH_MOD.blockDraftingTable), MCH_Config.ItemRecipe_DraftingTable.prmString));
  }
  ...
  public static void registerItemRecipe()
  {
    ...
    for (String name : mcheli.throwable.MCH_ThrowableInfoManager.getKeySet())
    {
      MCH_ThrowableInfo info = mcheli.throwable.MCH_ThrowableInfoManager.get(name);
  ...
  public static IRecipe addShapedRecipe(Item item, String data)
  {
    ...
    for (int i = 0; i < r.recipeItems.length; i++)
    {
      if (r.recipeItems[i] != null)
      {
        ...
        if (r.recipeItems[i].getItem() == null)
        {
  ...
  public static IRecipe addShapelessRecipe(Item item, String data)
  {
    ...
    {
      ItemStack is = (ItemStack)r.recipeItems.get(i);
