...
public abstract class W_Entity extends Entity
{
  ...
  {
    return entityDropItem(new net.minecraft.item.ItemStack(item, par2, 0), par3);
  }
  ...
  {
    return interact(par1EntityPlayer);
  }
  ...
  {
    if ((entity instanceof EntityLivingBase)) { ((EntityLivingBase)entity).removePotionEffectClient(id);
    }
  }
  ...
  {
    if ((entity instanceof EntityLivingBase)) { ((EntityLivingBase)entity).removePotionEffect(id);
    }
  }
  ...
  {
    if ((entity instanceof EntityLivingBase)) { ((EntityLivingBase)entity).addPotionEffect(pe);
    }
  }
