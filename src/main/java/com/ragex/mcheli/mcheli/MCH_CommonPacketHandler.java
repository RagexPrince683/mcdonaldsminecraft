...
{
  public MCH_CommonPacketHandler() {}
  ...
  public static void onPacketNotifyServerSettings(EntityPlayer player, ByteArrayDataInput data)
  {
    ...
    mcheli.lweapon.MCH_ClientLightWeaponTickHandler.lockRange = MCH_ServerSettings.stingerLockRange;
  }
    ...
    if (!player.worldObj.isRemote)
    {
      if (pkt.entityID >= 0)
      {
        ...
        if (target != null)
        {
          ...
          } else if (target.ridingEntity != null)
          {
