...
@cpw.mods.fml.common.Mod(modid="mcheli", name="mcheli", dependencies="required-after:Forge@[10.13.2.1230,)")
...
public class MCH_MOD
{
  ...
  @cpw.mods.fml.common.SidedProxy(clientSide="mcheli.MCH_ClientProxy", serverSide="mcheli.MCH_CommonProxy")
  ...
  public void PreInit(FMLPreInitializationEvent evt)
  {
    ...
    mcheli.wrapper.W_ItemList.init();
    ...
    W_LanguageRegistry.addNameForObject(blockDraftingTable, "ja_JP", "???");
  ...
  {
    EntityRegistry.registerModEntity(MCH_EntitySeat.class, "MCH.E.Seat", 100, this, 400, 10, true);
    
    EntityRegistry.registerModEntity(MCH_EntityHeli.class, "MCH.E.Heli", 101, this, 400, 10, true);
    
    EntityRegistry.registerModEntity(mcheli.gltd.MCH_EntityGLTD.class, "MCH.E.GLTD", 102, this, 200, 10, true);
    
    EntityRegistry.registerModEntity(MCP_EntityPlane.class, "MCH.E.Plane", 103, this, 400, 10, true);
    ...
    EntityRegistry.registerModEntity(MCH_EntityVehicle.class, "MCH.E.Vehicle", 108, this, 400, 10, true);
    
    EntityRegistry.registerModEntity(MCH_EntityUavStation.class, "MCH.E.UavStation", 109, this, 400, 10, true);
    ...
    EntityRegistry.registerModEntity(mcheli.tank.MCH_EntityTank.class, "MCH.E.Tank", 112, this, 400, 10, true);
    

    EntityRegistry.registerModEntity(mcheli.weapon.MCH_EntityRocket.class, "MCH.E.Rocket", 200, this, 530, 5, true);
    ...
    EntityRegistry.registerModEntity(mcheli.weapon.MCH_EntityATMissile.class, "MCH.E.ATMissle", 207, this, 530, 5, true);
    
    EntityRegistry.registerModEntity(mcheli.weapon.MCH_EntityBomb.class, "MCH.E.Bomb", 208, this, 530, 5, true);
    
    EntityRegistry.registerModEntity(MCH_EntityMarkerRocket.class, "MCH.E.MkRocket", 209, this, 530, 5, true);
    
    EntityRegistry.registerModEntity(mcheli.weapon.MCH_EntityDispensedItem.class, "MCH.E.DispItem", 210, this, 530, 5, true);
    




    EntityRegistry.registerModEntity(mcheli.flare.MCH_EntityFlare.class, "MCH.E.Flare", 300, this, 330, 10, true);
  ...
  private void registerItemSpawnGunner()
  {
    ...
    W_LanguageRegistry.addNameForObject(item, "ja_JP", "?????? ???");
  ...
  public void registerItemGLTD()
  {
    ...
    W_LanguageRegistry.addNameForObject(item, "ja_JP", "GLTD:??????????");
  }
  ...
  public static void registerItemThrowable()
  {
    ...
    {
      info = MCH_ThrowableInfoManager.get(name);
  ...
  public static void registerItemAircraft()
  {
    ...
    {
      info2 = (MCP_PlaneInfo)MCP_PlaneInfoManager.map.get(name);
      info2.item = new MCP_ItemPlane(info2.itemID);
      ...
      {
        registerItem(info2.item, name, creativeTabsPlane);
      }
      ...
      for (String lang : info2.displayNameLang.keySet())
      {
    ...
    {
      info3 = (MCH_TankInfo)MCH_TankInfoManager.map.get(name);
      info3.item = new MCH_ItemTank(info3.itemID);
      ...
      {
        registerItem(info3.item, name, creativeTabsTank);
      }
      ...
      for (String lang : info3.displayNameLang.keySet())
      {
        W_LanguageRegistry.addNameForObject(info3.item, lang, (String)info3.displayNameLang.get(lang));
      }
    }
    
    MCH_VehicleInfo info4;
    for (String name : MCH_VehicleInfoManager.map.keySet())
    {
      info4 = (MCH_VehicleInfo)MCH_VehicleInfoManager.map.get(name);
      info4.item = new MCH_ItemVehicle(info4.itemID);
      ...
      {
        registerItem(info4.item, name, creativeTabsVehicle);
      }
      ...
      for (String lang : info4.displayNameLang.keySet())
      {
