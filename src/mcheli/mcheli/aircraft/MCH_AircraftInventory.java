  ...
  implements IInventory
{
  ...
  public void consumeParachute() {
    for (int i = 0; i < 2; i++)
    {
      ...
      if ((item != null) && ((item.getItem() instanceof MCH_ItemParachute)))
      {
        setInventorySlotContents(3 + i, null);
        break;
      }
    }
  }
      ...
      for (int i = 0; i < getSizeInventory(); i++)
      {
        ...
        if (itemstack != null)
        {
          ...
          while (itemstack.stackSize > 0)
          {
            ...
            EntityItem entityitem = new EntityItem(this.aircraft.worldObj, this.aircraft.posX + x, this.aircraft.posY + y, this.aircraft.posZ + z, new ItemStack(itemstack.getItem(), j, itemstack.getItemDamage()));
  ...
  {
    if (this.aircraft.getAcInfo() == null) return "";
