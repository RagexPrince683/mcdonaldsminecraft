...
{
  public MCH_ItemLightWeaponRender() {}
  ...
  public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data)
  {
    ...
    if (isRender)
    {
      renderItem(item, W_Lib.castEntityLivingBase((Entity)data[1]), type == IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON);
    }
  }
  ...
  {
    if ((pitem == null) || (pitem.getItem() == null)) { return;
    }
    ...
    mcheli.MCH_ModelManager.render("lweapons", name);
