...
public class MCH_Math
{
  ...
  {
    FVector3D v = new FVector3D();
    v.x = x;
    v.y = y;
    v.z = z;
    return v; }
  
  public static FVector3D newVec3D() { return instance.privateNewVec3D(0.0F, 0.0F, 0.0F); }
  public static FVector3D newVec3D(float x, float y, float z) { return instance.privateNewVec3D(x, y, z); }
  ...
  public static FQuat newQuat() { return instance.privateNewQuat(); }
  ...
  public static FMatrix newMatrix() { return instance.privateNewMatrix(); }
  ...
  public float atan2(float y, float x) { return Atan2(y, x); }
  ...
  public static FQuat QuatMult(FQuat lpP, FQuat lpQ)
  {
    ...
    float pw = lpP.w;float px = lpP.x;float py = lpP.y;float pz = lpP.z;
    float qw = lpQ.w;float qx = lpQ.x;float qy = lpQ.y;float qz = lpQ.z;
