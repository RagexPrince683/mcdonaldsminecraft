  ...
  extends CreativeTabs
{
  ...
  public void setFixedIconItem(String itemName)
  {
    if (itemName.indexOf(':') >= 0)
    {
      ...
      if (this.fixedItem != null) this.fixedItem.setTextureName(itemName);
    }
    else
    {
      this.fixedItem = W_Item.getItemByName("mcheli:" + itemName);
      if (this.fixedItem != null) { this.fixedItem.setTextureName("mcheli:" + itemName);
      }
    }
  }
