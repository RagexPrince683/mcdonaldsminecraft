...
public class MCH_ItemRendererDummy extends ItemRenderer
{
  ...
  public void renderItemInFirstPerson(float par1)
  {
    ...
    else if ((!(mc.thePlayer.ridingEntity instanceof mcheli.aircraft.MCH_EntityAircraft)) && (!(mc.thePlayer.ridingEntity instanceof mcheli.uav.MCH_EntityUavStation)) && (!(mc.thePlayer.ridingEntity instanceof MCH_EntityGLTD)))
    {
  ...
  {
    if (instance == null) instance = new MCH_ItemRendererDummy(Minecraft.getMinecraft());
