...
public class MCH_ItemUavStation extends W_Item
{
  ...
  public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
  {
    ...
    if (mcheli.wrapper.W_MovingObjectPosition.isHitTypeTile(movingobjectposition))
    {
      ...
      MCH_EntityUavStation entityUavSt = createUavStation(par2World, i + 0.5F, j + 1.0F, k + 0.5F, this.UavStationKind);
      




      int rot = (int)(mcheli.MCH_Lib.getRotate360(par3EntityPlayer.rotationYaw) + 45.0D);
      entityUavSt.rotationYaw = (rot / 90 * 90 - 180);
      entityUavSt.initUavPostion();
      
      if (!par2World.getCollidingBoundingBoxes(entityUavSt, entityUavSt.boundingBox.expand(-0.1D, -0.1D, -0.1D)).isEmpty())
      {
        return par1ItemStack;
      }
      ...
      {
        par2World.spawnEntityInWorld(entityUavSt);
      }
