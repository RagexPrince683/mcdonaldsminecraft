...
public class MCH_ItemContainer extends mcheli.wrapper.W_Item
{
  ...
  public net.minecraft.item.ItemStack onItemRightClick(net.minecraft.item.ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
  {
    ...
    if (mcheli.wrapper.W_MovingObjectPosition.isHitTypeTile(movingobjectposition))
    {
      ...
      MCH_EntityContainer entityboat = new MCH_EntityContainer(par2World, i + 0.5F, j + 1.0F, k + 0.5F);
      entityboat.rotationYaw = (((MathHelper.floor_double(par3EntityPlayer.rotationYaw * 4.0F / 360.0F + 0.5D) & 0x3) - 1) * 90);
